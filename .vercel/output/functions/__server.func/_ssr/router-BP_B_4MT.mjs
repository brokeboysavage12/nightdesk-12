...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BP_B_4MT.js
...
function Toaster$1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
		...
		toastOptions: { classNames: {
			toast: "bg-surface text-fg shadow-[0_0_0_1px_rgba(236,234,228,0.08)] border-0",
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 rounded-sm bg-raised px-2 py-1 text-xs text-fg shadow-[var(--shadow-border)]", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-Dr9W_SeE.css";
var APP_NAME = "NightDesk";
var Route$5 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Overnight YouTube desk. Scripts, voice, stills, and a Short ready to upload — no editor required."
			},
			{
				name: "theme-color",
				content: "#0b0c0e"
...
var $$splitComponentImporter$4 = () => import("./routes-Qfr5moKL.mjs");
var Route$4 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./board-rkH0s9bk.mjs");
var Route$3 = createFileRoute("/board")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./channel-BhD94rz8.mjs");
var Route$2 = createFileRoute("/channel")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./playbook-BXEKsXNL.mjs");
var Route$1 = createFileRoute("/playbook")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./video._id-CbseZIIk.mjs");
var Route = createFileRoute("/video/$id")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var rootRouteChildren = {
	...
	ChannelRoute: Route$2.update({
		id: "/channel",
		path: "/channel",
		getParentRoute: () => Route$5
	}),
	PlaybookRoute: Route$1.update({
		id: "/playbook",
		path: "/playbook",
		getParentRoute: () => Route$5
	}),
	VideoIdRoute: Route.update({
		id: "/video/$id",
		path: "/video/$id",
		getParentRoute: () => Route$5
	})
