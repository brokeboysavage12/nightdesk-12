//#region node_modules/.nitro/vite/services/ssr/assets/niches-DqFCaehY.js
var NICHES = [
	{
		id: "last-24",
		index: "01",
		...
		imageBible: "Cinematic documentary still, photoreal, 35mm film grain, dusk and smoke, empty streets, archival mood, no text, no logos, no watermarks, no celebrity likeness, no modern UI.",
	...
	},
	{
		...
		imageBible: "Cinematic still of forbidden archives, candlelit vellum, stone corridors, smoke in light shafts, photoreal, no text, no logos, no watermarks, no faces of famous living people.",
	...
	},
	{
		...
		imageBible: "Quiet crime-desk still, fogged glass, empty rural road at night, manila folders, analog desk lamp, photoreal film, no text, no logos, no identifiable real victim faces.",
	...
	},
	{
		...
		imageBible: "Photoreal night city with no power, empty interstate, analog maps on a table, cold blue-black light, cinematic still, no text, no logos, no watermarks.",
	...
	},
	{
		...
		imageBible: "Clinical cinematic still, fluorescent hallway, cracked mirror, lonely apartment lamp, cool desaturated palette, photoreal, no text, no logos, no watermarks.",
	...
	},
	{
		...
		imageBible: "Aerial ruin in mist, abandoned concrete, rusted rail into fog, photoreal landscape still, overcast, no text, no logos, no people in focus, no watermarks.",
	...
	},
	{
		...
		imageBible: "Old-money interior, leather ledgers, rain on a dark harbor, photoreal cinematic still, tungsten light, no text, no logos, no watermarks, no living billionaires.",
	...
	},
	{
		...
		imageBible: "Wilderness night still, frost, tree line, river ice, a single distant light, photoreal cinematic, no text, no logos, no watermarks.",
...
var VOICES = [
	{
		id: "atlas",
		name: "Atlas",
		line: "Low documentary. Default for history."
	},
	{
		id: "rex",
		name: "Rex",
		line: "Grave news desk."
	},
	{
		id: "orion",
		name: "Orion",
	...
	},
	{
		id: "helix",
		name: "Helix",
		line: "Cinematic, a little distant."
	},
	{
		id: "eve",
		name: "Eve",
		line: "Closer, brighter — psychology and traps."
	},
	{
		id: "luna",
		name: "Luna",
...
//#endregion
export { getNiche as i, NICHES as n, VOICES as r, CADENCE_LABEL as t };
