...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CCnM_en3.mjs");
...
var manifest = {
	"0e37eabcba6353a5384f0c1bfa8547890823ee12288e02107042df2feae902d8": {
		functionName: "generateImage_createServerFn_handler",
		importer: () => import("./ai-5SLlLIrD.mjs")
	},
	"ce9988eb7e7c86779f68ca532a781f8023023f678abd92779fd8fddab59302f3": {
		functionName: "generateVoice_createServerFn_handler",
		importer: () => import("./ai-5SLlLIrD.mjs")
	},
	"cf886653e28a101e892a68daaadd44f4a4b684c4b9b8eab6f712b67a6d440fc8": {
		functionName: "generateIdeas_createServerFn_handler",
		importer: () => import("./ai-5SLlLIrD.mjs")
	},
	"f792689d94fd0e4814dbeb8aff9d601c10c69d205dae4982c05f66b4021e1242": {
		functionName: "generatePackage_createServerFn_handler",
		importer: () => import("./ai-5SLlLIrD.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BP_B_4MT.mjs").then((n) => n.t),
